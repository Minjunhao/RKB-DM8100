...
#if 0  
/* PHY registers */
#define PHY_MICR                  0x11 /* RMII Interrupt Control Register */
...
#endif
/* PHY registers */
#define PHY_MICR                  30 /* RMII Interrupt Control Register */
#define PHY_MICR_INT_EN           ((uint16_t)0x0010) /* PHY Enable interrupts */
//#define PHY_MICR_INT_OE           ((uint16_t)0x0001) /* PHY Enable output interrupt events */
#define PHY_MISR                  29 /* MII Interrupt Status and Misc. Control Register */
//#define PHY_MISR_LINK_INT_EN      ((uint16_t)0x0020) /* Enable Interrupt on change of link status */
#define PHY_LINK_STATUS           ((uint16_t)0x0010) /* PHY link status interrupt mask */   
