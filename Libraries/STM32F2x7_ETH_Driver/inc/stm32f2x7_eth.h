...
typedef enum MAC_INITIAL_STATUS{
   PHY_RESET =0,
   PHY_RESET_DELAY_CHECK,
   PHY_LINK_STATUS_CHECKING,
   PHY_ATUO_NEG_CHECKING,
   PHY_MAC_SETTING,
   PHY_MAC_NORMAL
} MAC_INITIAL_TYPE;
typedef enum{
   PHY_ADDR_WRITE,
   PHY_ADDR_WAIT_RESPONSE,
} PHY_ADDR_RWTYPE;
extern PHY_ADDR_RWTYPE phy_addr_RW;
extern MAC_INITIAL_TYPE PHY_initial_status;
